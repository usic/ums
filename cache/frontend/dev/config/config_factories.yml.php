...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/home/caelum/public_html/project/log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/home/caelum/public_html/project/cache/frontend/dev/i18n',
  'lifetime' => 31556926,
  ...
  $class = sfConfig::get('sf_factory_routing', 'sfPatternRouting');
      $cache = new sfFileCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/caelum/public_html/project/cache/frontend/dev/config/routing',
  'lifetime' => 31556926,
...
'database' => $this->getDatabaseManager()->getDatabase('session'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/caelum/public_html/project/cache/frontend/dev/template',
  'lifetime' => 86400,
