...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'notice',
  'file' => '/home/caelum/public_html/project/log/frontend_prod.log',
)));
$this->factories['logger']->addLogger($logger);

$logger = new sfVarLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'err',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/home/caelum/public_html/project/cache/frontend/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/home/caelum/public_html/project/apps/frontend/i18n',
));
  ...
  $class = sfConfig::get('sf_factory_routing', 'sfPatternRouting');
      $cache = new sfFileCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/caelum/public_html/project/cache/frontend/prod/config/routing',
  'lifetime' => 31556926,
  'prefix' => '/home/caelum/public_html/project/apps/frontend/routing',
));
...
if ($parameters = $this->factories['routing']->parse($this->factories['request']->getPathInfo()))
{
  ...
  $class = sfConfig::get('sf_factory_storage', 'sfPDOSessionStorage');
  $this->factories['storage'] = new $class(array_merge(array(
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('usic'),
'database' => $this->getDatabaseManager()->getDatabase('session'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/caelum/public_html/project/cache/frontend/prod/template',
  'lifetime' => 86400,
  'prefix' => '/home/caelum/public_html/project/apps/frontend/template',
)));
