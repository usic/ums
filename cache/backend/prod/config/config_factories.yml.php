...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/home/caelum/public_html/project/log/backend_prod.log',
)));
...
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/home/caelum/public_html/project/cache/backend/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/home/caelum/public_html/project/apps/backend/i18n',
));
  ...
  $class = sfConfig::get('sf_factory_routing', 'sfPatternRouting');
      $cache = new sfFileCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/caelum/public_html/project/cache/backend/prod/config/routing',
  'lifetime' => 31556926,
  'prefix' => '/home/caelum/public_html/project/apps/backend/routing',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('wtf'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/caelum/public_html/project/cache/backend/prod/template',
  'lifetime' => 86400,
  'prefix' => '/home/caelum/public_html/project/apps/backend/template',
)));
